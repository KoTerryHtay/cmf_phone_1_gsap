export default function DisplayIcon() {
  return (
    ...
    >
      ...
      ></path>
      <path
        d="M10 1C10 1.55228 9.55228 2 9 2C8.44772 2 8 1.55228 8 1C8 0.447715 8.44772 0 9 0C9.55228 0 10 0.447715 10 1Z"
        fill="currentColor"
      ></path>
      <path
        d="M12 1C12 1.55228 11.5523 2 11 2C10.4477 2 10 1.55228 10 1C10 0.447715 10.4477 0 11 0C11.5523 0 12 0.447715 12 1Z"
        fill="currentColor"
      ></path>
      <path
        d="M4 7C4 7.55228 3.55228 8 3 8C2.44772 8 2 7.55228 2 7C2 6.44772 2.44772 6 3 6C3.55228 6 4 6.44772 4 7Z"
        fill="currentColor"
      ></path>
      <path
      ...
      ></path>
      <path
        d="M4 11C4 11.5523 3.55228 12 3 12C2.44772 12 2 11.5523 2 11C2 10.4477 2.44772 10 3 10C3.55228 10 4 10.4477 4 11Z"
        fill="currentColor"
      ></path>
      <path
      ...
      ></path>
      <path
        d="M4 13C4 13.5523 3.55228 14 3 14C2.44772 14 2 13.5523 2 13C2 12.4477 2.44772 12 3 12C3.55228 12 4 12.4477 4 13Z"
        fill="currentColor"
      ></path>
      <path
